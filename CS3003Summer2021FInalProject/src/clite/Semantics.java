...
public class Semantics {
    ...
    State M(Program p) {
        // The meaning of a program is the meaning of main with both the globals and
        // main's StackFrames on the state's stack.
    ...
    /*
     * returns the initial state of a program pushes globals then main onto stack
     */
